...
public class GlobalEnvironment {
	...
	public GlobalEnvironment(OperatingSystemType os, DatabaseType db, DatabaseSize s) { //String envFileDir){
		osType = os;
		dbType = db;
		dbSize = s;
		
		String fileDir = fdirWindows;
		if(osType == OperatingSystemType.LINUX)	fileDir = fdirLinux;
		
		File envFile = new File(fileDir + "/" + ENV_FILE);
...
//	public GlobalEnvironment(int numVertex){
//		int numEdges = numVertex * 5;
//		createEnvironment(numVertex, 2, 3, numEdges, 2, 2, DEFAULT_DIR);
//	}
	
	public GlobalEnvironment(int numVertex, int numVertexTypes, int maxV_fields,
