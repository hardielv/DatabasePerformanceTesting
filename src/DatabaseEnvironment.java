...
public class DatabaseEnvironment {
	...
	public DatabaseEnvironment(String envFileDir){
	...
	public DatabaseEnvironment(int numVertex){
		int numEdges = numVertex * 5;
		createEnvironment(numVertex, 2, 3, numEdges, 2, 2, DEFAULT_DIR);
	}
	
	public DatabaseEnvironment(int numVertex, int numVertexTypes, int maxV_fields,
